...
last word (the number may be zero), and between words (at least one between any pair of neighbouring words),
...
def song_decoder(song):
    ...
    original_name = song.replace("||", "|").replace("|", " ").replace("  ", " ")
...
if __name__ == "__main__":
    ...
    print(song_decoder("WEWUBAREWUBWUBTHEWUBCHAMPIONSWUBMYWUBFRIENDWUB"))
